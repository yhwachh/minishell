...
char	*malloc_and_chr(char *str);
void	pwd(char **tp);
void	cd(char **str);
void	ft_env(char **str);
void	ft_echo(char **str, char **find, char *line);
void	ft_redirect(char **tp, char **env, char *str);
...
void	ft_redirect_one(char **tp, char **env, char *str);
void	ft_redirect_two(char **tp, char **env, char *str);
void	ft_redirect_tree(char **tp, char **env, char *str);
